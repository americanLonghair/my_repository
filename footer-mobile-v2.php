...
?>
    ...
    <footer id="colophon" class="site-footer">
         ...
         */
        do_action( 'electro_mobile_footer_v2' ); //若进if判断则通过do_action()钩子函数执行 electro_mobile_footer_v2相关代码  ?>

    </footer><!-- #colophon -->

    <?php endif; ?>

    <?php do_action( 'electro_after_mobile_footer_v2' ); //钩子函数执行electro_after_mobile_footer_v2相关代码 ?>
